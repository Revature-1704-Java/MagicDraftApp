...
module.exports = "<p id=\"demo\">draft-interface works!</p>\r\n"
            ...
            if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    for (var j = 0; j < obj[i].length; j++) {
                        ...
                        var imgurl = "<img src=\"" + grabImage(temp[j].name) + "\">";
                        console.log(imgurl);
